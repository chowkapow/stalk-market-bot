...
async def help(ctx):
    ...
    embed.add_field(
        name="**$add**",
        value='Add your price with "$add buy n", "$add sell n", "$add sell n am", "$add sell n pm"',
        inline=False,
    )
    embed.add_field(
        name="**$clear**",
        value='Clear your prices with "$clear", "$clear buy", "$clear sell", "$clear sell am", "$clear sell pm"',
        inline=False,
    )
    embed.add_field(
    ...
    embed.add_field(
        name="**$trends**",
        value="See the trends for your prices via [turnipprophet.io](https://turnipprophet.io)\n**DISCLAIMER**: Site not written by me",
        inline=False,
    )
